...
function CreateContainer() {
  ...
  const [alerStatus, setAlerStatus] = useState("danger");
  ...
  return (
    <div className="w-full min-h-screen flex items-center justify-center">
      <div
        className="w-[90%] md:w-[50%] border border-gray-300 rounded-lg p-4 flex flex-col
      ...
      >
        ...
        <div className="w-full py-2 border-b  border-gray-300 flex items-center gap-2">
          ...
          <input
            ...
            className="w-full h-full text-lg bg-transition outline-one rounded-md  font-sans
          ...
          {isLoading ? (
            ...
            <>
              {!imgeAsset ? (
                <>
                  <label
                    className="w-full  h-full justify-center items-center flex-col 
          border-dotted border-gray-300 h-255 md:h-420 cursor-pointer rounded-lg"
                  >
