  ...
  return (
    ...
    >
      ...
      {cartItems && cartItems.length > 0 ? (
        <div className="w-[98%] h-full bg-cartBg rounded-[2rem] flex flex-col ml-2 ">
          {/* cart item section */}
          <div
        ...
        justify-evenly px-8 py-2"
          >
            <div className="w-full flex items-center justify-between">
              <p className="text-gray-400 text-lg 	text-transform: capitalize">
                Tổng Tiền Hàng
              </p>
            ...
            <div className="w-full flex items-center justify-between">
              ...
              <p className="text-gray-400 text-lg">30đ</p>
            </div>
            <div className="w-full border-b border-gray-600 my-2"></div>
            <div className="w-full flex items-center justify-between">
              <p className="text-gray-200 text-xl font-sans text-transform: capitalize ">
                Tổng Thanh Toán
              </p>
              <p className="text-gray-200 text-xl font-sans">{tot + 30}</p>
            </div>
            {user ? (
              <motion.button
                whileTap={{ scale: 0.75 }}
                type="button"
                className="w-full p-2 rounded-full bg-gradient-to-tr from-yellow-400 to-yellow-500
        ...
        <div className="w-ful h-full flex flex-col items-center justify-center gap-6">
          <img src={EmptyCart} className="w-300" alt="" />
          <p className="text-xl text-textColor font-sans">
